...
export const FacebookChart = radialCommonOption(radial1);
// Twitter
const radial2 = {
    color: ["#FFA941"],
...
export const TwitterChart = radialCommonOption(radial2);
//Instagram
const radial3 = {
    color: ["#57B9F6"],
...
export const InstagramChart = radialCommonOption(radial3);
// //Youtube
const radial4 = {
    color: ["#48A3D7"],
...
export const YoutubeChart = radialCommonOption(radial4);
...
export let cryptoCurrencyPrices = {
    chart: {
        toolbar: {
            show: false,
        },
...
export let orderStatusProcesses = {
    chart: {
        height: 350,
        type: "line",
        stacked: true,
