export const commanList = [
    {
        id: 1,
        title: "Default Lists",
        subTitle: "Use the <code>.list-group </code>define the list of items. and used <code>.list-group-item </code>to indicate the current content.",
        data: [
            {
                name: "Logo Design",
            },
    ...
    },
    {
        id: 2,
        title: "Active Lists",
        subTitle: "Use<code>.active </code>to a<code>.list-group-item</code> to indicate the current active.",
        data: [
            {
                name: "UI Kits",
    ...
    },
    {
        id: 2,
        title: "Flush lists",
        subTitle: "Use <code> .list-group-flush</code> to remove some borders and rounded corners to render list group items.",
